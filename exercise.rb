...
SELECT name FROM dinos WHERE period='Cretaceous' OR period='Jurassic' ORDER BY name ASC;
...
SELECT name FROM dinos WHERE t_order='Saurischia' AND diet='Herbivorous' ORDER BY name ASC;
